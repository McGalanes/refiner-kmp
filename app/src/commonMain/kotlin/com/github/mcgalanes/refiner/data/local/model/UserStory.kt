...
import com.github.mcgalanes.refiner.domain.entity.UserStoryEntity as UserStoryEntity
...
fun UserStory.toDomainLayer(criterias: List<UserStoryEntity.CriteriaEntity>): UserStoryEntity =
    UserStoryEntity(
        id = id,
        title = title,
        persona = persona,
...
fun UserStoryEntity.toDataLayer(): UserStory =
    UserStory(
        id = id,
        title = title,
        persona = persona,
